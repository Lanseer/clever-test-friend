...
const categories = ["接口规范", "测试模板", "框架指南", "性能标准", "安全规范"];
...
export function CreateDocumentDialog({ open, onOpenChange }: CreateDocumentDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onOpenChange(false);
    // 重置表单
    setFormData({ name: "", category: "", version: "v1.0.0", description: "" });
    setFile(null);
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!formData.name || !formData.category || !file}
            >
              创建文档
            </Button>
          </DialogFooter>
